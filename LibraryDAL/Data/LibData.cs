    ...
    public class LibData
    {
        public List<LibDataModel> dataInsert()
        {
             List<LibDataModel> Data = new();
            {
                ...
                Data.Add(new LibDataModel { Id = 3, Title = "Technical Writing", Author = "Karan Ahuja", Publisher = "UIT", Price = 80.00 });
                Data.Add(new LibDataModel { Id = 4, Title = "Cryptography Design", Author = "Rakhi Khare", Publisher = "UIT", Price = 250.00 });
